...
class API
{
    ...
    private static $api_version = '2.1'; // We want it to be treated as a string
    ...
    public static function GetRawData($url, $post_data=null)
    {
        ...
        if($data === FALSE)
        {
            ...
            throw new APIException('Curl was unable to retrieve the data from the specified URL.'.$url." " . $error_desc,
                                   $url, $error_desc);
        }
